...
import FetchLocation, {detectPosition} from "../components/FetchLocation";
...
class Campings extends React.Component {
  ...
  renderDetectLocation(){
    return(
      <View style={styles.settings}>
        <FetchLocation onGetLocation={detectPosition()} /> 
      </View>
    )
  }
